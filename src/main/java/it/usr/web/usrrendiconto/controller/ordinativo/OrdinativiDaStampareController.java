...
@Named
@ViewScoped
public class OrdinativiDaStampareController extends BaseController {
    @Inject
    OrdinativiService os;
    @Inject
    CodiceService cs;    
    List<Ordinativo> ordinativiDaStampare;    
    List<Integer> anni;
    List<Codice> codici;
    ...
    public void initialize() {
        ordinativiDaStampare = os.getOrdinativiDaStampare();
        anni = os.getAnniOrdinativi();
        codici = cs.getCodici();        
    }

    public List<Ordinativo> getOrdinativiDaStampare() {
        return ordinativiDaStampare;
    }        
